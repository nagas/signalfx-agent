...
The agent files will be installed to `\Program Files\SignalFx\SignalFxAgent`, and the default configuration file
will be installed at `\ProgramData\SignalFxAgent`.
...
_Only available for Smart Agent v5.3.0 or higher._
